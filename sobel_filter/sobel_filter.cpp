...
int main() {
    const char* inputFile = "photo_630x630_centercrop.bmp";
    const char* outputFile = "output_grayscale_photo_630x630_centercrop.bmp";
    const int IMAGE_WIDTH = 630;
    const int IMAGE_HEIGHT = 630;

    // 1. ======== 파일 생성 추가 ========
    const char* edgeFile = "output_edge_photo_630x630_centercrop.bmp";        // 엣지 검출 BMP 파일 추가
    const char* memFile = "output_image_photo_630x630_centercrop.mem";  // MEM 파일 이름 추가
    
    // 2. 파일 포인터 추가 (라인 93-95 근처)
